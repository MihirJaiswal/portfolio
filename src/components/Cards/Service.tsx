              ...
              <div key={service.id}>
                <div className="relative mb-2 lg:mb-4 group transition-all duration-300">
                  <div className="flex items-center p-1 md:p-3">
                    ...
                    <div className="flex-1 py-2 px-4 rounded-lg xs:rounded-4xl bg-white dark:bg-neutral-950 text-black dark:text-white border group-hover:bg-black group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-black transition-all mx-4 xs:mx-0">
