      ...
      <div className="px-6">
        <div className="flex justify-center md:justify-between items-center">
          <div className="flex flex-col items-center justify-center mb-6 md:mb-0">
            <h2 className="text-6xl md:text-7xl lg:text-8xl font-extrabold mb-6 md:mb-0">
            ...
            <p className='md:hidden text-[18px] tracking-tight text-neutral-600 dark:text-neutral-400'>
